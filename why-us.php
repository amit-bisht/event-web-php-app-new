...
<div class="box-layout">
       ...
       <?php include 'includes/navbar.php'; ?>
        <!-- end header -->
        <!-- start page title -->
            <section class="top-space-margin page-title-big-typography border-radius-6px lg-border-radius-0px p-0" data-parallax-background-ratio="0.5" style="background-image: url(https://craftohtml.themezaa.com/images/demo-corporate-services-title-bg.jpg)">
                ...
                <div class="container">
                    <div class="row align-items-center justify-content-center small-screen">
                        <div class="col-lg-8 position-relative text-center page-title-extra-large" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                            <h1 class="m-auto text-white text-shadow-double-large fw-600 ls-minus-2px">Why Us</h1>
                        </div>
                                ...
                                <div class="swiper-wrapper mb-10px">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <p class="w-95 xl-w-100">
                                            Our expert team possesses a deep understanding of client requirements. With many years of industry  experience, we are equipped to handle challenges effectively and provide comprehensive 360 degree solutions, ensuring the  best support and Execution.
At our core, we prioritize a deep understanding of our clients' visions. We believe that every project is unique, and we are  dedicated to capturing the essence of your ideas. Our commitment to executing these visions flawlessly sets us apart. We  combine meticulous planning with innovative solutions, ensuring that every detail aligns with your goals. With us, you can  trust that your vision will not only be understood but brought to life with precision and excellence.
                                        </p>
                                    </div>
