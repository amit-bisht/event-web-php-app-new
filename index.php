    ...
    <div class="box-layout">
       ...
       <?php include 'includes/navbar.php'; ?>
                ...
                <div id="demo-corporate-slider" class="rev_slider bg-regal-blue fullscreenbanner" style="display:none;"
                    ...
                    <ul>
                        ...
                        <li data-index="rs-01" data-transition="parallaxleft" data-slotamount="default"
                            ...
                            <img src="images/bg_two.png" alt="Image" data-bgposition="center center" data-bgfit="cover"
                                ...
                                <div class="tp-caption  " id="slide-1-layer-04" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption" id="slide-1-layer-05" data-x="['left','left','left','left']"
                                        ...
                                        <div class="tp-caption mx-auto text-uppercase" id="slide-1-layer-06"
                                            ...
                                            <i class="bi bi-award pe-5px icon-small"></i>MAKING WAVES IN BRANDING
                                        </div>
                                        <!-- end subtitle layer -->
                                        <!-- start title layer -->
                                        <div class="tp-caption mx-auto" id="slide-1-layer-07"
                                            ...
                                            Elevating Brands, Perfecting Events.
                                        </div>
                                        <!-- end title layer -->
                                        <!-- start text layer -->
                                        <div class="tp-caption mx-auto" id="slide-1-layer-08"
                                            ...
                                            We are a full-service agency creating seamless brand experiences, from
                                            custom advertising to end-to-end event management.
                                        </div>
                                        <!-- end text layer -->
                                        <!-- start button layer -->
                            ...
                            <div class="tp-caption d-inline-block" id="slide-1-layer-11"
                                ...
                                <i class="bi bi-patch-check-fill icon-extra-medium d-block pb-10px"></i> <span
                                    class="d-block text-uppercase">FLAWLESS EXECUTION</span>
                            </div>
                        ...
                        <li data-index="rs-02" data-transition="parallaxleft" data-slotamount="default"
                            ...
                            data-description="">
                            <!-- slide's main background image -->
                            <img src="images/bg_three.png" alt="Image" data-bgposition="center center"
                                ...
                                <div class="tp-caption  " id="slide-2-layer-04" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption" id="slide-2-layer-05" data-x="['left','left','left','left']"
                                        ...
                                        <div class="tp-caption mx-auto" id="slide-2-layer-07"
                                            ...
                                            data-paddingbottom="[33,28,35,25]" data-paddingleft="[0,0,0,0]"
                                            style="word-break: initial; text-shadow: #0b1236 3px 3px 15px;">
                                            Tangible Branding, Lasting Impressions.
                                        </div>
                                        <!-- end title layer -->
                                        <!-- start text layer -->
                                        <div class="tp-caption mx-auto" id="slide-2-layer-08"
                                            ...
                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                            data-paddingbottom="[36,36,60,40]" data-paddingleft="[0,0,0,0]">
                                            Turn hydration into a powerful advertising tool. We put your brand directly
                                            into the hands of your audience with high-impact, custom water bottles.
                                        </div>
                                        <!-- end text layer -->
                                        <!-- start button layer -->
                            ...
                            <div class="tp-caption d-inline-block" id="slide-2-layer-11"
                                ...
                                data-paddingleft="[0,0,0,0]" style="word-break: initial;">
                                <i class="bi bi-patch-check-fill icon-extra-medium d-block pb-10px"></i> <span
                                    class="d-block text-uppercase">RESULTS DRIVEN</span>
                            </div>
                            <!-- end beige text layer -->
                        </li>
                        <li data-index="rs-03" data-transition="parallaxleft" data-slotamount="default"
                            ...
                            data-description="">
                            <!-- slide's main background image -->
                            <img src="images/bg_one.png" alt="Image" data-bgposition="center center" data-bgfit="cover"
                                data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- start overlay layer -->
                                ...
                                <div class="tp-caption  " id="slide-3-layer-04" data-x="['left','left','left','left']"
                                    ...
                                    <div class="tp-caption" id="slide-3-layer-05" data-x="['left','left','left','left']"
                                        ...
                                        <div class="tp-caption mx-auto" id="slide-3-layer-07"
                                            ...
                                            data-paddingbottom="[33,28,35,25]" data-paddingleft="[0,0,0,0]"
                                            style="word-break: initial; text-shadow: #0b1236 3px 3px 15px;">
                                            A New Wave of Engagement is Coming.
                                        </div>
                                        <!-- end title layer -->
                                        <!-- start text layer -->
                                        <div class="tp-caption mx-auto" id="slide-3-layer-08"
                                            ...
                                            data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
                                            data-paddingbottom="[36,36,60,40]" data-paddingleft="[0,0,0,0]">
                                            We're expanding our suite of innovative branding solutions. Stay tuned to
                                            discover new ways to make your mark.
                                        </div>
                                        <!-- end text layer -->
                                        <!-- start button layer -->
                            ...
                            <div class="tp-caption d-inline-block" id="slide-3-layer-11"
                                ...
                                data-paddingleft="[0,0,0,0]" style="word-break: initial;">
                                <i class="bi bi-patch-check-fill icon-extra-medium d-block pb-10px"></i> <span
                                    class="d-block text-uppercase">CREATIVE PARTNER</span>
                            </div>
                            <!-- end beige text layer -->
                        </li>
                    </ul>
                ...
                <div class="row row-cols-1 row-cols-md-3 row-cols-sm-2 justify-content-center"
                    ...
                    <div
                        ...
                        <div
                            class="d-flex flex-column flex-lg-row align-items-center justify-content-center text-center text-lg-start">
                            <div class="flex-shrink-0 me-15px md-me-0">
                                <h2 class="mb-0 fw-800 ls-minus-3px">4.65</h2>
                            </div>
                            <div>
                                ...
                                <span class="lh-24 fw-600 d-block">Successful Events Managed</span>
                            </div>
                        </div>
                    </div>
                    <!-- end content box item -->
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center mb-6 sm-pb-9">
                    <div class="col-lg-6 col-md-9 position-relative md-mb-15 text-center text-lg-start"
                        ...
                        <div class="absolute-middle-center z-index-9 counter-style-02 text-center">
                            <span
                                class="fs-160 fw-800 text-dark-gray ls-minus-10px xs-ls-minus-5px position-relative lg-fs-130 xs-fs-75">90<sub
                                    class="align-top fs-80 lg-fs-70 text-dark-gray position-relative top-minus-3px">+</sub></span>
                            <span
                                class="d-block mx-auto fs-20 fw-500 lh-26 w-70 text-center text-dark-gray xs-w-100">Predefined
                                Bottle Labels</span>
                        </div>
                        <img src="images/demo-corporate-03.png" alt="">
                        <img src="images/img_trophy.png"
                    ...
                    <div class="col-lg-6 ps-6 text-center text-lg-start lg-ps-15px"
                        ...
                        <span
                            class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Measurable
                            Impact</span>
                        <h3 class="text-dark-gray fw-700 ls-minus-1px">A Strategic Partner for Your Brand's Biggest
                            Moments.</h3>
                        <p class="w-80 xl-w-90 lg-w-100 mb-40px sm-mb-25px">At WaveNeer, we believe true brand impact is
                            For brands seeking innovative and high-impact marketing, Wave Neer offers a unique advantage
                            by turning reusable bottles into powerful advertising tools. Unlike traditional ads that are
                            quickly forgotten, branded bottles travel with people in their daily lives, providing
                            repeated exposure and reinforcing brand recall. The integration of QR codes allows instant
                            customer interaction, driving traffic directly to your website, campaigns, or offers.
                            Distributed strategically at events and gatherings, they ensure your brand reaches the right
                            audience in a tangible, memorable way. This approach not only delivers long-lasting
                            visibility at a fraction of ongoing ad costs but also positions your brand as
                            environmentally conscious, which resonates strongly with today’s consumers. </p>
                        <a href="asset/Our%20Services.pdf" target="_blank" rel="noopener noreferrer"
                        ...
                        <span class="text-dark-gray fw-700 ls-minus-05px d-block d-sm-inline-block sm-mt-15px"><a
                                href="tel:9990655548"><i class="feather icon-feather-phone-call me-10px"></i>+91
                                9990655548</a></span>
                    </div>
                </div>
                <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 justify-content-center counter-style-07 ps-3 pe-3"
                    ...
                    <div class="col text-center sm-mb-30px">
                        ...
                        <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">SUCCESSFUL EVENTS</span>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col text-center sm-mb-30px">
                        ...
                        <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">CLIENT SATISFACTION</span>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col text-center sm-mb-30px">
                        ...
                        <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">BRANDED UNITS DELIVERED</span>
                    </div>
                    <!-- end counter item -->
                    <!-- start counter item -->
                    <div class="col text-center">
                        ...
                        <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">CORPORATE PARTNERS</span>
                    </div>
                    <!-- end counter item -->
                </div>
            </div>
        ...
        <section
            ...
            <img src="https://via.placeholder.com/760x792"
            ...
            <div class="container">
                <div class="row align-items-center mb-6 sm-mb-9 text-center text-lg-start">
                    <div class="col-lg-5 md-mb-20px">
                        <span
                            class="ps-25px pe-25px mb-10px text-uppercase text-white fs-13 lh-42px fw-600 border-radius-100px bg-gradient-blue-whale-transparent d-inline-block">OUR
                            EXPERTISE</span>
                        <h3 class="text-white fw-700 mb-0 ls-minus-1px">Solutions for Every Industry</h3>
                    </div>
                    <div class="col-lg-5 last-paragraph-no-margin md-mb-20px">
                        <p class="w-85 md-w-100">Your industry is unique. We deliver tailored branding and event
                            solutions designed to connect with your audience and achieve memorable results.</p>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            ...
                                            <img src="images/img_Service_One.png" />
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <span class="text-white fw-600 fs-20">Healthcare</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Health
                                                        & Wellness Events</span>
                                                    <a
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Two.png" alt="" />
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Real Estate</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">High-Impact
                                                        Property Launches</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Three.png
" alt="" />
                                            <div class="opacity-very-light bg-slate-blue"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Travel & Tourism</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Impactful
                                                        Destination Branding</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Four.png
" alt="" />
                                            <div class="opacity-very-light bg-slate-blue"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Banking Finance</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Secure
                                                        Investor Summits</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Five.png
" alt="" />
                                            <div class="opacity-extra-medium bg-gradient-dark-transparent"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Food & Beverage</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Memorable
                                                        Tasting Events</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Six.png
" alt="" />
                                            <div class="opacity-very-light bg-slate-blue"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Political</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Effective
                                                        Campaign Visibility</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Seven.png
" alt="" />
                                            <div class="opacity-very-light bg-slate-blue"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Legal & Law Firms</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Exclusive
                                                        Legal Conferences</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                                    ...
                                    <div class="swiper-slide">
                                        ...
                                        <div
                                            class="interactive-banner-style-09 border-radius-6px overflow-hidden position-relative">
                                            <img src="images/img_Service_Eight.png
" alt="" />
                                            <div class="opacity-very-light bg-slate-blue"></div>
                                            <div
                                                class="image-content h-100 w-100 ps-15 pe-15 pt-13 pb-13 md-p-10 d-flex justify-content-bottom align-items-start flex-column">
                                                ...
                                                <div
                                                    class="mt-auto d-flex align-items-start w-100 z-index-1 position-relative overflow-hidden flex-column">
                                                    <span class="text-white fw-600 fs-20">Manufacturing</span>
                                                    <span
                                                        class="content-title text-white fs-13 fw-500 text-uppercase ls-05px">Dynamic
                                                        Product Showcases</span>
                                                    <a
                                                        class="content-title-hover fs-13 lh-24 fw-500 ls-05px text-uppercase text-white opacity-6 text-decoration-line-bottom">Explore
                                                        services</a>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <div class="fs-18 text-white d-inline-block align-middle">Save your precious time and effort
                            spent for finding the best solution. <a href="mailto:contact@waveneer.com"
                                class="text-white text-decoration-line-bottom">Contact us now</a></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container position-relative">
                <div class="row align-items-center mb-7">
                    <div class="col-xxl-4 col-lg-5 md-mb-15 sm-mb-20 text-center text-lg-start">
                        <span
                            class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Our
                            Proven Process</span>
                        <h3 class="text-dark-gray fw-700 ls-minus-2px mb-40px">How We Bring Your Vision to Life.</h3>
                        <div class="row row-cols-1"
                            ...
                            <div class="col-12 process-step-style-05 position-relative hover-box">
                                <div class="process-step-item d-flex">
                                    ...
                                    <div class="process-content ps-30px last-paragraph-no-margin mb-30px">
                                        <span class="d-block fw-700 text-dark-gray mb-5px fs-18">Discovery &
                                            Strategy</span>
                                        <p class="w-90 lg-w-100 lh-32">We align with your goals to craft a high-impact
                                            plan.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 process-step-style-05 position-relative hover-box">
                                <div class="process-step-item d-flex">
                                    ...
                                    <div class="process-content ps-30px last-paragraph-no-margin mb-30px">
                                        <span class="d-block fw-700 text-dark-gray mb-5px fs-18">Design &
                                            Planning</span>
                                        <p class="w-90 lg-w-100 lh-32">Meticulous planning of every detail, from
                                            logistics to custom merchandise.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- end process step item -->
                            ...
                            <div class="col-12 process-step-style-05 position-relative hover-box xs-mb-30px">
                                <div class="process-step-item d-flex">
                                    ...
                                    <div class="process-content ps-30px last-paragraph-no-margin">
                                        <span class="d-block fw-700 text-dark-gray mb-5px fs-18">Execution &
                                            Impact</span>
                                        <p class="w-90 lg-w-100 lh-32">Flawless on-site management for a memorable and
                    ...
                    <div class="col-lg-7 offset-xxl-1 position-relative md-mb-30px sm-mb-15"
                        ...
                        <img src="images/img_Step_675.png" class="position-relative z-index-9 top-40px" alt="">
                        <img src="images/demo-corporate-03.png" class="absolute-middle-center xs-w-95" alt="">
                        <!-- <img src="images/img_144x64.png"
                            class="position-absolute top-50px left-0px xs-left-15px"
                            data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)"
                            alt="">
                        <img src="images/img_67x34.png" class="position-absolute top-150px left-30"
                            data-bottom-top="transform: translateY(30px)" data-top-bottom="transform: translateY(-30px)"
                            alt="">
                        <img src="images/img_61x30.png" class="position-absolute top-50px right-30"
                            data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)"
                            alt="">
                        <img src="images/img_93x45.png"
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-12 text-center align-items-center"
                        ...
                        <div
                            ...
                            READY TO START?</div>
                        <div class="fs-18 fw-500 text-dark-gray d-inline-block align-middle">Let's make your next event
                            unforgettable. <a href="mailto:contact@waveneer.com"
                                class="text-dark-gray text-decoration-line-bottom fw-700">Got a project in mind?</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container background-no-repeat background-position-top"
                ...
                <div class="row justify-content-center mb-3">
                    <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-9 text-center"
                        data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="text-dark-gray fw-700 ls-minus-1px">Trusted by the world's fastest growing companies
                        </h3>
                    </div>
                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row align-items-center justify-content-center">
                                        <div class="col-8 col-md-4 col-sm-6 text-center md-mb-30px">
                                            <img alt="" src="images/img_profile.png">
                                        </div>
                                        <div
                                            class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                            <a href="#" class="mb-15px d-block"><img
                                                    src="images/logo-monday-dark-blue-01.svg" class="h-35px" alt=""></a>
                                            <span class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray">Their team
                                                are easy to work with and helped me make amazing websites in a short
                                                amount of time. Thanks guys for all your hard work. Trust us we looked
                                                for a very long time.</span>
                                            <span class="fs-15 text-uppercase fw-800 text-base-color ls-1px">Herman
                                                miller, Monday</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div
                                            class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                            <a href="#" class="mb-15px d-block"><img
                                                    src="images/logo-loitech-dark-blue.svg" class="h-35px" alt=""></a>
                                            <span class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray">Their team
                                                are easy to work with and helped me make amazing websites in a short
                                                amount of time. Thanks guys for all your hard work. Trust us we looked
                                                for a very long time.</span>
                                            <span class="fs-15 text-uppercase fw-800 text-base-color ls-1px">Leonel
                                                mooney, Logitech</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end testimonial item -->
                                ...
                                <div class="swiper-slide">
                                    <div class="row align-items-center justify-content-center">
                                        ...
                                        <div
                                            class="col-lg-5 col-md-7 last-paragraph-no-margin text-center text-md-start">
                                            <a href="#" class="mb-15px d-block"><img
                                                    src="images/logo-invision-dark-blue.svg" class="h-35px" alt=""></a>
                                            <span class="mb-5px d-table fs-18 lh-30 fw-500 text-dark-gray">Their team
                                                are easy to work with and helped me make amazing websites in a short
                                                amount of time. Thanks guys for all your hard work. Trust us we looked
                                                for a very long time.</span>
                                            <span class="fs-15 text-uppercase fw-800 text-base-color ls-1px">Matthew
                                                taylor, invision</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- end testimonial item -->
                ...
                <div class="row justify-content-center"
                    ...
                    <div class="col-12">
                        <div class="border-radius-6px h-450px md-h-350px sm-h-400px d-flex flex-wrap align-items-center justify-content-center overflow-hidden cover-background box-shadow-quadruple-large pt-15"
                            style="background-image: url('images/img_YouTubeBanner.png')">
                            ...
                            <div class="row justify-content-center m-0">
                                <div class="col-lg-7 col-md-8 z-index-1 text-center text-md-start sm-mb-20px">
                                    <h3 class="text-white mb-0 fw-400 fancy-text-style-4">Branding that<span
                                            class="fw-600"
                                            data-fancy-text='{ "effect": "rotate", "string": ["connects", "engages!", "impresses"] }'></span>
                                    </h3>
                                </div>
                                <div class="col-md-2 position-relative z-index-1 text-center sm-mb-20px">
                                    <a href="https://www.youtube.com/watch?v=YGQBm9Mnad8&ab_channel=AcceleratedVideo"
                            ...
                            <div
                                ...
                                <div class="fs-14 text-uppercase text-white fw-600 ls-05px">Let's make your next event
                                    unforgettable. <a href="mailto:contact@waveneer.com"
                                        class="text-decoration-line-bottom text-white">Got a project in mind?</a></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- end section -->
        <!-- start section -->
        <!-- This Sectin is removed from here this was used for pricing -->
        <!-- end section -->
        <!-- start section -->
            ...
            <div class="container">
                <div class="row justify-content-center mb-3">
                    <div class="col-lg-7 text-center"
                        data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h3 class="text-dark-gray fw-700 ls-minus-1px">Our Clients</h3>
                    </div>
                </div>
                <div class="row mb-5 sm-mb-7">
                    <div class="col-12">
                        <!-- Autoplay horizontal clients slider (uses existing Swiper init via data-slider-options) -->
                        <div class="clients-grid">
                            <div class="swiper clients-swiper" data-slider-options='{"loop": true, "autoplay": {"delay": 1800, "disableOnInteraction": false}, "slidesPerView": 5, "spaceBetween": 24, "breakpoints": {"1200": {"slidesPerView": 5}, "992": {"slidesPerView": 4}, "768": {"slidesPerView": 3}, "320": {"slidesPerView": 2}}}'>
                                <div class="swiper-wrapper align-items-center">
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_zepto.png" alt="Zepto" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_croma.png" alt="Croma" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_sunPharma.png" alt="Sun Pharma" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_onsitego.png" alt="OnsiteGo" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_kdm.png" alt="KDM" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_muthootfinance.png" alt="Muthoot Finance" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_dsgroup.png" alt="DS Group" class="h-45px" /></a></div>
                                    <div class="swiper-slide text-center"><a href="#" class="d-inline-block"><img src="images/logo_park.png" alt="Park" class="h-45px" /></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mb-7 sm-mb-9"
                    data-anime='{ "el": "childs", "translateY": [0, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                    <div class="col text-center">
                        <div>
                            <a href="https://forms.gle/2wS1AnueQUjHsHsk6"
                                ...
                                <span>
                                    ...
                                    <span class="btn-icon"><i class="feather icon-feather-edit"></i></span>
                                </span>
                            </a>
                        </div>
                    </div>
