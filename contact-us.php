...
<div class="box-layout">
       ...
       <!-- start page title -->
            <section class="top-space-margin page-title-big-typography border-radius-6px lg-border-radius-0px p-0" data-parallax-background-ratio="0.5" style="background-image: url('images/demo-corporate-contact-parallax-img.jpg')">
                ...
                <div class="container"> 
                    ...
                    <div class="row row-cols-1 row-cols-xl-4 row-cols-lg-4 row-cols-md-2 row-cols-sm-2 mb-6 sm-mb-8" data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay":0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        ...
                        <div class="col md-mb-30px text-center text-sm-start">
                            ...
                            <a href="mailto:contact@waveneer.com">contact@waveneer.com</a>
                        </div>
                        <div class="col xs-mb-30px text-center text-sm-start">
                            ...
                            <a href="tel:1800222000">91 - 9911201557</a><br>
                            <a href="tel:1800222002">91 - 9990655548</a>
                        </div>
            ...
            <!-- end section -->
            <!-- start section --> 
            <section class="position-relative one-half-screen sm-small-screen overflow-hidden border border-radius-top-lr lg-border-radius-0px" data-parallax-background-ratio="0.5" style="background-image: url('images/dem')">
