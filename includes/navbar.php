                ...
                <div class="container-fluid">
                    <div class="col-auto col-xl-3 col-lg-2 me-lg-0 me-auto">
                        <a class="navbar-brand" href="index.html">
                            <img src="images/demo-corporate-logo-black.png"
                                data-at2x="images/demo-corporate-logo-black@2x.png" alt="" class="default-logo">
                            <img src="images/demo-corporate-logo-black.png"
                                data-at2x="images/demo-corporate-logo-black@2x.png" alt="" class="alt-logo">
                            <img src="images/demo-corporate-logo-black.png"
                                data-at2x="images/demo-corporate-logo-black@2x.png" alt="" class="mobile-logo">
                        </a>
                    </div>
                        ...
                        <div class="header-icon">
                                ...
                                <div class="search-form-wrapper">
                                    ...
                                    <form id="search-form" role="search" method="get" class="search-form text-left"
                                        ...
                                        <div class="search-form-box">
                                            <h2 class="text-dark-gray text-center fw-600 mb-4 ls-minus-1px">What are you
                                                looking for?</h2>
                            ...
                            <div class="header-button ms-20px d-none d-xl-inline-block">
                                <a href="contact-us.php"
                                    ...
                                    <span>
                                        <span class="btn-double-text fw-600" data-text="Contact Us">Contact Us</span>
